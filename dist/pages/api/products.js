...
// src/pages/api/products.ts
var products_default = async (req, res) => {
  ...
  if (session) {
    ...
    const products = await prisma.product.findMany({
      where: {
        ...
        price: {
          in: priceFrom && priceTo ? [parseInt(priceFrom), parseInt(priceTo)] : void 0
        },
        category: {
          name: {
            equals: category ? category : void 0
          }
        },
        date: {
          every: {
            stock: {
              in: stockFrom && stockTo ? [parseInt(stockFrom), parseInt(stockTo)] : void 0
            }
          }
        }
      },
