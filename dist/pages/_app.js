...
var AuthGuard = ({ children }) => {
  const { status, data: data2 } = (0, import_react.useSession)();
...
var MainLink = ({ icon, color, label, pageLink }) => {
  ...
  return /* @__PURE__ */ import_react7.default.createElement(import_link.default, { href: pageLink, passHref: true }, /* @__PURE__ */ import_react7.default.createElement(
    ...
    /* @__PURE__ */ import_react7.default.createElement(import_core2.Group, null, /* @__PURE__ */ import_react7.default.createElement(import_core2.ThemeIcon, { color, variant: "light" }, icon), /* @__PURE__ */ import_react7.default.createElement(import_core2.Text, { size: "sm" }, label))
  ));
};
var data = [
  {
    icon: /* @__PURE__ */ import_react7.default.createElement(AiOutlineHome, { size: 18 }),
    color: "blue",
    label: "Home",
    pageLink: "/"
  },
  {
    icon: /* @__PURE__ */ import_react7.default.createElement(BiCategory, { size: 18 }),
    color: "teal",
    label: "Categorias",
    pageLink: "/categories"
  },
  {
    icon: /* @__PURE__ */ import_react7.default.createElement(BsBox, { size: 16 }),
    color: "violet",
    label: "Invent\xE1rio",
    pageLink: "/inventory"
  },
  {
    icon: /* @__PURE__ */ import_react7.default.createElement(TbClipboardList, { size: 20 }),
    color: "grape",
    label: "Produtos",
    pageLink: "/products"
  },
  {
    icon: /* @__PURE__ */ import_react7.default.createElement(FiSettings, { size: 16 }),
    color: "orange",
...
var Brand = () => {
  ...
  return /* @__PURE__ */ import_react7.default.createElement(
    ...
    /* @__PURE__ */ import_react7.default.createElement(import_core2.Group, { position: "apart", align: "center" }, /* @__PURE__ */ import_react7.default.createElement(import_core2.Group, null, /* @__PURE__ */ import_react7.default.createElement(
      import_core2.ThemeIcon,
      {
        variant: "gradient",
      ...
      /* @__PURE__ */ import_react7.default.createElement(GoArchive, { size: 18 })
    ), /* @__PURE__ */ import_react7.default.createElement(import_core2.Title, { size: "1.2rem", weight: 400, sx: { fontStyle: "italic" } }, "Invent\xE1rio")), /* @__PURE__ */ import_react7.default.createElement(
      ...
      colorScheme === "dark" ? /* @__PURE__ */ import_react7.default.createElement(ImSun, { size: 18 }) : /* @__PURE__ */ import_react7.default.createElement(ImIcoMoon, { size: 18 })
    ))
  );
};
var User = () => {
  const theme = (0, import_core2.useMantineTheme)();
  const { data: session } = (0, import_react6.useSession)();
  const router = (0, import_router2.useRouter)();
  return /* @__PURE__ */ import_react7.default.createElement(import_link.default, { passHref: true, href: router.pathname === "/configura\xE7\xF5es" ? "/" : "/configura\xE7\xF5es" }, /* @__PURE__ */ import_react7.default.createElement(
    import_core2.Box,
    {
      sx: {
    ...
    /* @__PURE__ */ import_react7.default.createElement(
      ...
      /* @__PURE__ */ import_react7.default.createElement(import_core2.Group, null, /* @__PURE__ */ import_react7.default.createElement(
        import_core2.Avatar,
        {
      ...
      ), /* @__PURE__ */ import_react7.default.createElement(import_core2.Box, { sx: { flex: 1 } }, /* @__PURE__ */ import_react7.default.createElement(import_core2.Text, { size: "sm", weight: 500 }, session?.user?.name), /* @__PURE__ */ import_react7.default.createElement(import_core2.Text, { color: "dimmed", size: "xs" }, session?.user?.email)), router.pathname === "/settings" ? /* @__PURE__ */ import_react7.default.createElement(MdKeyboardArrowLeft, { size: 18 }) : /* @__PURE__ */ import_react7.default.createElement(MdKeyboardArrowRight, { size: 18 }))
    )
  ));
};
var Nav = ({
  ...
  return /* @__PURE__ */ import_react7.default.createElement(
    ...
    /* @__PURE__ */ import_react7.default.createElement(import_core2.Navbar.Section, { mt: "xs" }, /* @__PURE__ */ import_react7.default.createElement(Brand, null)),
    /* @__PURE__ */ import_react7.default.createElement(import_core2.Navbar.Section, { grow: true, mt: "md", component: import_core2.ScrollArea }, data.map((link, index) => /* @__PURE__ */ import_react7.default.createElement(MainLink, { ...link, key: link.label }))),
    /* @__PURE__ */ import_react7.default.createElement(import_core2.Navbar.Section, null, /* @__PURE__ */ import_react7.default.createElement(User, null))
  );
};
...
var PageLayout = ({ children }) => {
  ...
  const { status } = (0, import_react8.useSession)();
  return /* @__PURE__ */ React.createElement(
    import_core3.AppShell,
    {
      styles: {
        main: {
      ...
      header: /* @__PURE__ */ React.createElement(import_core3.Header, { height: 70, p: "md" }, /* @__PURE__ */ React.createElement(
        "div",
        {
          style: { display: "flex", alignItems: "center", height: "100%" }
        },
        /* @__PURE__ */ React.createElement(import_core3.MediaQuery, { largerThan: "sm", styles: { display: "none" } }, /* @__PURE__ */ React.createElement(
          import_core3.Burger,
          {
            opened,
        ...
        /* @__PURE__ */ React.createElement(import_core3.Text, null, "Fornecedores Hortifruti Higien\xF3polis")
      ))
    },
    children
  );
...
function App({
  ...
  const [colorScheme, setColorScheme] = (0, import_react11.useState)("dark");
  const toggleColorScheme = (value) => setColorScheme(value || (colorScheme === "dark" ? "light" : "dark"));
  return /* @__PURE__ */ React.createElement(import_react_query.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React.createElement(
    import_core4.ColorSchemeProvider,
    {
      colorScheme,
      toggleColorScheme
    },
    /* @__PURE__ */ React.createElement(
      import_core4.MantineProvider,
      {
      ...
      /* @__PURE__ */ React.createElement(
        import_react10.SessionProvider,
        {
          session,
          refetchInterval: 5 * 60,
          refetchOnWindowFocus: true
        },
        Component.requireAuth ? /* @__PURE__ */ React.createElement(AuthGuard_default, null, /* @__PURE__ */ React.createElement(PageLayout_default, null, /* @__PURE__ */ React.createElement(Component, { ...pageProps }))) : /* @__PURE__ */ React.createElement(Component, { ...pageProps }),
        /* @__PURE__ */ React.createElement(import_react_query_devtools.ReactQueryDevtools, { position: "bottom-right" })
      )
    )
  ));
}
